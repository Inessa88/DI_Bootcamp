...
function getCarHonda(array) {
  const newArray = array.find((element) => (element.car_make === "Honda"));
    const sentence = `This is a ${newArray.car_make} ${newArray.car_model} from ${newArray.car_year}.`;
...
function sortCarInventoryByYear(array) {
  const sortedByYear = array.sort(function(x,y){
